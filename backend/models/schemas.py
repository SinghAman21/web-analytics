...
class EventData(BaseModel):
    ...
    first_touch_source_type: Optional[str] = Field(None, description="First-touch source type")
    first_touch_source_name: Optional[str] = Field(None, description="First-touch source name")
    first_touch_source_url: Optional[str] = Field(None, description="First-touch source URL")
    first_touch_landing_url: Optional[str] = Field(None, description="First-touch landing URL")
    first_touch_landing_path: Optional[str] = Field(None, description="First-touch landing path")
    first_touch_at: Optional[str] = Field(None, description="First-touch timestamp in ISO format")
    first_touch_click_id: Optional[str] = Field(None, description="First-touch click identifier")
    first_touch_utm_source: Optional[str] = Field(None, description="First-touch UTM source")
    first_touch_utm_medium: Optional[str] = Field(None, description="First-touch UTM medium")
    first_touch_utm_campaign: Optional[str] = Field(None, description="First-touch UTM campaign")
    first_touch_utm_content: Optional[str] = Field(None, description="First-touch UTM content")
    first_touch_utm_term: Optional[str] = Field(None, description="First-touch UTM term")
